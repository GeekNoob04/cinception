  ...
  return (
    <div className="w-screen aspect-video pt-[16%] px-6 md:px-8 absolute text-white bg-gradient-to-r from-black/70 via-black/30 to-transparent z-10">
      ...
      <div className="flex flex-wrap mt-6">
        <button className="bg-white text-black py-2 px-8 text-lg font-medium rounded-lg flex items-center justify-center ">
          <svg
        ...
        <button className="bg-gray-600/80 text-white py-2 px-8 text-lg font-medium rounded-lg ml-4 flex items-center">
          <svg
